...
help:
	...
	@printf '  %-30s %s\n' 'build' 'Build and package the debug app directly'
	@printf '  %-30s %s\n' 'run' 'Build, package, and launch the debug app directly'
	@printf '  %-30s %s\n' 'test' 'Run the Swift test suite directly'
	...
	@printf '  %-30s %s\n' 'dev-test' 'Coordinated test run; override with FILTER=name, including Pi tests'
	...
	@printf '\n%s\n' 'Release and local-production targets:'
	@printf '  %-30s %s\n' 'release-preflight' 'Run release preflight directly'
	@printf '  %-30s %s\n' 'release-artifact' 'Build release artifact directly'
	@printf '  %-30s %s\n' 'install-local-production' 'Install a local production app directly'
