...
class WorkspaceFileContextStoreTestCase: XCTestCase {
    ...
    func runTestRepeatedPathLookupReusesStaticSnapshotForUnchangedCatalogGeneration() async throws {
        #if DEBUG
    ...
    func runTestExplicitRootRefsUseDistinctStaticSnapshotsAndDoNotPoisonCanonicalScope() async throws {
    ...
    func runTestSessionBoundStaticSnapshotCacheUsesBoundedLRUEviction() async throws {
        #if DEBUG
    ...
    func runTestStaticSnapshotLRUEvictionPreservesRetainedSearchCatalogGeneration() async throws {
        #if DEBUG
    ...
    func runTestSessionBoundStaticSnapshotInvalidatesForMutationAndRootUnload() async throws {
        #if DEBUG
    ...
    func runTestWatcherReplayDuplicateDeltasAreIdempotent() async throws {
        ...
        func runTestSessionWorktreeOwnershipIsIdempotentSharedAndLastReleaseUnloads() async throws {
        ...
        func runTestSessionWorktreeOwnershipReleaseDuringRootLoadUnloadsLateRoot() async throws {
        ...
        func runTestStartWatchingMissingRootThrowsWithoutRetainingDemand() async throws {
            let store = WorkspaceFileContextStore()
        ...
        func runTestSessionWorktreeOwnershipActivationFailureRollsBackClaimsAndRoot() async throws {
    ...
    func runTestStoreOwnedOverwriteDefersOnlyItsSyntheticModificationAndPreservesWatcherIsolationAndFallbacks() async throws {
        do {
    ...
    func runTestApplyEditsRejectsDiskMissingStaleCatalogBase() async throws {
        ...
        private func waitForCodemapCounters(
            ...
            line: UInt = #line,
            until predicate: (WorkspaceCodemapMemoryCounters) -> Bool
        ) async -> WorkspaceCodemapMemoryCounters {
...
final class WorkspaceFileContextStoreCorePart2Tests: WorkspaceFileContextStoreTestCase {
        ...
        func testSessionWorktreeOwnershipIsIdempotentSharedAndLastReleaseUnloads() async throws {
            try await runTestSessionWorktreeOwnershipIsIdempotentSharedAndLastReleaseUnloads()
        }
    #endif
    #if DEBUG
        func testSessionWorktreeOwnershipReleaseDuringRootLoadUnloadsLateRoot() async throws {
            try await runTestSessionWorktreeOwnershipReleaseDuringRootLoadUnloadsLateRoot()
        }
    #endif
    #if DEBUG
        func testStartWatchingMissingRootThrowsWithoutRetainingDemand() async throws {
            try await runTestStartWatchingMissingRootThrowsWithoutRetainingDemand()
        }
    #endif
    #if DEBUG
        func testSessionWorktreeOwnershipActivationFailureRollsBackClaimsAndRoot() async throws {
            try await runTestSessionWorktreeOwnershipActivationFailureRollsBackClaimsAndRoot()
        }
    #endif
    #if DEBUG
...
final class WorkspaceFileContextStoreSearchPart2Tests: WorkspaceFileContextStoreTestCase {
    ...
    func testStoreOwnedOverwriteDefersOnlyItsSyntheticModificationAndPreservesWatcherIsolationAndFallbacks() async throws {
        try await runTestStoreOwnedOverwriteDefersOnlyItsSyntheticModificationAndPreservesWatcherIsolationAndFallbacks()
    }
