...
private enum AppSettingsMCPRegistry {
    ...
    static let definitions: [AppSettingDefinition] = [
        ...
        boolSetting(
            ...
            description: "Whether Codex Agent Mode app-server threads request Codex model reasoning summaries. Defaults off; when disabled RepoPrompt sends model_reasoning_summary=none in Codex thread/start and thread/resume config.",
