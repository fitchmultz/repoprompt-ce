        ...
        Button {
            ...
            HStack(alignment: .top, spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text("Currently: \(promptVM.contextBuilderAgentSelectionDisplayName). Configure which CLI agent and model Context Builder uses in Agent Models.")
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        HStack(spacing: 6) {
                            Image(systemName: "brain")
                                .foregroundColor(.secondary)
                                .font(.caption)
                            Text("Analysis uses the Oracle Model: \(promptVM.planningModelSelectionDisplayName). Change it in Agent Models.")
                                .font(fontPreset.captionFont)
                                .foregroundColor(.secondary)
                                .fixedSize(horizontal: false, vertical: true)
                        }
