...
public class APISettingsViewModel: ObservableObject {
    ...
    @Published var availablePiModelOptions: [AgentModelOption] = []
    var piLogCollector: CLIProcessLogCollector?
    ...
    var piPreflightTask: Task<Void, Never>?
    var piPolicyChangeTask: Task<Void, Never>?
    var piModelsTask: Task<Void, Never>?
    var piModelsSubscribedWorkspacePath: String?
    ...
    let piModelPollingService: any PiModelPolling
    let piConnectionDefaults: UserDefaults
